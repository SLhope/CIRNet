...
class BaseOptions():
    ...
    def initialize(self):
        ...
        # for setting input
        self.parser.add_argument('--freq', default=-1, type=float, help='selected items from group dataset')  
        self.parser.add_argument('--serial_batches', action='store_true', help='if true, takes images in order to make batches, otherwise takes them randomly')
        self.parser.add_argument('--fliplr', default=-1, type=float, help='the rate to flip the image left-right')  
        self.parser.add_argument('--flipud', default=-1, type=float, help='the rate to flip the image up-down')  
        self.parser.add_argument('--noise', default=False, type=bool, help='the rate to flip the image up-down')  
        self.parser.add_argument('--imgsize', type=str, default='small', help='image size: small ...')
        ...
        self.parser.add_argument('--display_id', type=int, default=0, help='window id of the web display (use 0 to disable visdom)')
